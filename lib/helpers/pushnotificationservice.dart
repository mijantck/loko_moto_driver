...
import 'package:loko_moto_driver/widgets/NotificationDialog.dart';
...
class PushNotificationService{
  ...
  Future<String> getToken() async{
    ...
    DatabaseReference tokenRef = FirebaseDatabase.instance.reference().child('drivers/${uidu}/token');
    tokenRef.set(token);
