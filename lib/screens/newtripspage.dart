...
import 'package:loko_moto_driver/helpers/mapkithelper.dart';
...
class _NewTripPageState extends State<NewTripPage> {
  ...
  void acceptTrip(){
    ...
    DatabaseReference historyRef = FirebaseDatabase.instance.reference().child('drivers/${uidu}/history/$rideID');
    historyRef.set(true);
